...
def arbitrageBetCalculator(bet, o1, o2):
    ...
    if(isThereArbitrage(o1, o2)[0]): #valid Arbitrage
        ...
        if (o1[:1] == "+" and o2[:1] == "+"): #if 1st and 2nd line are underdog
            ...
            betForLine2 = reverseProfitCalculator(profitLine1+bet, o2) #calculates money needed to equal payout for favorite line
...
print(arbitrageBetCalculator(100, "-300", "+380")) #Will need to input values from json file using API