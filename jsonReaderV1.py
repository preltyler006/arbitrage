'''
This function is bad, too convoluted, remade into V2
'''
...
#             j = 0 # Bookmaker counter

#             for dict in secondary_dict: # for every dictionary in secondary dict, dictionary of 1 game across all bookmakers
#                 tertiary_dict = dict["markets"] # create a third market from the secondary dictionary to go even deeper

#                 for d in tertiary_dict: # for every dictionary in third dict, dictionary of 1 bookmaker and 1 game
